...
import { postLogin, getCookie } from "@/servers/commonApi";
        ...
        <div className='flex login-content'>
          <div className='login-form'>
            ...
            <div className='login-form-content'>
              <CInput value={this.state.adminName} placeholder='请输入用户名' onChange={(value) => this.changHandler(value, 'adminName')} onEnter={this.login} />
              <CInput type='password' value={this.state.adminPassword} placeholder='请输入密码' onChange={(value) => this.changHandler(value, 'adminPassword')} onEnter={this.login} />
