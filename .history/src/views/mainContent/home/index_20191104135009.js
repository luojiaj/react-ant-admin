...
class Home extends stateData {
  ...
  render() {
    const { selectedRowKeys, tableLoading, delLoading, data,statuLoading } = this.state;
    const rowSelection = {
      selectedRowKeys,
        ...
        <Card style={{ 'border-bottom': 0 }} bodyStyle={{ 'height': 62 }}>
          <Form>
            <Form.Item label="Switch">
              <Switch onChange={() => this.changeStatu()} loading={this.statuLoading} checkedChildren="开" unCheckedChildren="关" defaultChecked={record.isDownloadable == 0 ? false : true} />
            </Form.Item>
          </Form>
