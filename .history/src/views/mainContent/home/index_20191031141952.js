    ...
    const columns = [
      {
        ...
        render: (text, record) => (
          record.isShowChange == true ?
            <Input className="nameInput" onChange={() => this.changeName(this,record)} defaultValue={record.name} allowClear></Input> :
      ...
      },
      {
        ...
        render: (text, record) => (
          record.isShowChange == true ?
            <Input className="nameInput" onChange={() => this.changePhone(record)} defaultValue={record.phone} allowClear></Input> :
