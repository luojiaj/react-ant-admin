...
class Home extends stateData {
  ...
  changeName = (e, record) => {
    record.name=e.target.value, record;
    this.setState({});
  };
    ...
    const columns = [
      {
        ...
        render: (text, record) => (
          record.isShowChange == true ?
            <Input ref="nameInput" className="nameInput" onChange={(e) => this.changeName(e, record)} defaultValue={record.name} allowClear></Input> :
      ...
      },
      {
        ...
        render: (text, record) => (
          record.isShowChange == true ?
            <Input ref="PhoneInput" className="PhoneInput" onChange={(e) => this.changePhone(e, record)} defaultValue={record.phone} allowClear></Input> :
