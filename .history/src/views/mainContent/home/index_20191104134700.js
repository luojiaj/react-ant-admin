        ...
        <Card style={{ 'border-bottom': 0 }} bodyStyle={{ 'height': 62 }}>
          <Form>
            <Form.Item label="Switch">
              <Switch onChange={() => this.onChangeStatu()} loading={record.switchLoading} checkedChildren="开" unCheckedChildren="关" defaultChecked={record.isDownloadable == 0 ? false : true} />
            </Form.Item>
          </Form>
