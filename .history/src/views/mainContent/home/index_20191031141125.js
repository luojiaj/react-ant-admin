    ...
    const columns = [
      {
        ...
        render: (text, record) => (
          record.isShowChange == true ?
            <Input className="nameInput" onChange={() => this.changeName(e, record)} defaultValue={record.name} allowClear></Input> :
      ...
      },
      {
        ...
        render: (text, record) => (
          record.isShowChange == true ?
            <Input className="nameInput" onChange={this.changePhone} defaultValue={record.phone} allowClear></Input> :
