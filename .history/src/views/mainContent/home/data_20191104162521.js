...
import { getUsersList, putUser, delUserList, getDownloadPermission } from '@/servers/homeApi';
...
class stateData extends Component {
  ...
  constructor(props) {
    ...
    this.getUserDownloadPermission = this.getUserDownloadPermission.bind(this);
    this.userList();
    this.getUserDownloadPermission();
  }
  state = {
    data: [],//当前表格数据
    selectedRowKeys: [],
  ...
  //获取下载权限
  getUserDownloadPermission = () => {
    getDownloadPermission().then(res => {
