...
export const ajax_get = (url, params) => {
  return ajax_all('get', baseURL + url, params);
};

export const ajax_post = (url, data) => {
  return ajax_all('post', baseURL + url, {}, data);
};

export const ajax_put = (url, data) => {
  return ajax_all('put', baseURL + url, {}, data);
};

export const ajax_delete = (url, data) => {
  return ajax_all('delete', baseURL + url, {}, data);
};